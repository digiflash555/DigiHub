...
import {
    ...
    DollarSign, Upload, FileText, X, Send, Minus, Plus, LayoutDashboard
} from 'lucide-react';
...
const Dashboard = () => {
    ...
    const downloadQRWithTemplate = async (reg) => {
        try {
            await downloadEventPass({
                event: reg.event,
                participant: reg.participant || user,
                qrCode: reg.qrCode,
    ...
    return (
        <div className={`space-y-12 pb-40 relative ${isBirthday ? 'birthday-theme' : ''}`}>
            <StudentHeader
                title="My Dashboard"
                subtitle={`Welcome back, ${user.username}! Here's a summary of your activities and upcoming events.`}
