...
const Support = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-12 pb-40">
            <StudentHeader
                title="Help & Support"
                subtitle="Submit your complaints, suggestions, or technical issues. Our admin team will review and address them promptly."
                icon={HelpCircle}
                showHero={true}
            />
                            ...
                            >
                                {myQueries.length === 0 ? (
                                    <div className="bg-slate-50 dark:bg-[#1a1d24] rounded-[2.5rem] p-20 text-center space-y-4">
                                        ...
                                        <p className="text-slate-400 font-medium">Your user care history will appear here.</p>
                                    </div>
                                ) : (
                                    myQueries.map((q) => (
