...
import { User, Mail, Lock, Building2, ArrowRight, Loader2, ChevronRight, Sparkles, Phone, FileText, Tag, Calendar, Shield, Upload, X, ImageIcon, Eye, EyeOff } from 'lucide-react';
                ...
                <div className="bg-white dark:bg-[#20242B] rounded-[2.5rem] p-10 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.05)] border border-slate-100 dark:border-slate-800 dark:text-white">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-sm font-black text-slate-900 dark:text-slate-400 uppercase tracking-widest pl-1">Confirm Password</label>
                                <div className="relative">
                                    <input
