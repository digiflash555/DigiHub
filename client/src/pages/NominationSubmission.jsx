...
const NominationSubmission = () => {
    ...
    if (user?.role && user.role !== 'Participant' && user.role !== 'Student' && user.role !== 'Association Member') {
        return (
            <div className="max-w-2xl mx-auto text-center py-32 space-y-8">
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-12 pb-40">
            <StudentHeader
                ...
                subtitle="Step forward to lead. Apply for various association posts and share your vision for the community."
                icon={Award}
                badge="Leadership"
                showHero={true}
            />
