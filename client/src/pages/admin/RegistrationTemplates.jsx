    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8 pb-20 dark:text-white">
            <AdminTopBar
                ...
                subtitle="Design, build, import, and manage reusable dynamic event registration form templates."
                icon={Layout}
                badge="Form Studio"
                actions={
                    <div className="flex gap-3">
                        <label className="px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white font-bold rounded-xl flex items-center gap-2 transition-all cursor-pointer border border-white/10 text-sm">
                        ...
                        {!isCreating && (
                            <button 
                                ...
                                className="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl flex items-center gap-2 transition-all text-sm shadow-lg"
                            >
