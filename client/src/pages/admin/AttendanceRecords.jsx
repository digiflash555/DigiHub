        ...
        <div className="space-y-10 pb-40">
            ...
            {selectedEvent && (
                <div className="flex gap-3 flex-wrap">
                    <Link
                        to="/admin/settings"
                        className="bg-white dark:bg-[#20242B] text-slate-700 font-bold px-4 py-3 rounded-2xl border border-slate-200 dark:border-slate-700 flex items-center gap-2 hover:bg-slate-50 dark:hover:bg-[#2a2e36] transition-all shadow-sm dark:text-white"
                    ...
                    <button
                        ...
                        className="bg-white dark:bg-[#20242B] text-slate-700 font-bold px-6 py-3 rounded-2xl border border-slate-200 dark:border-slate-700 flex items-center gap-2 hover:bg-slate-50 dark:hover:bg-[#2a2e36] transition-all shadow-sm dark:text-white disabled:opacity-50"
                    >
