...
const GROUP_COLORS = {
    'Registered Participants': 'bg-blue-100 text-blue-700 border-blue-300',
    'Event Volunteers':        'bg-violet-100 text-violet-700 border-violet-300',
    'Faculty':                 'bg-emerald-100 text-emerald-700 border-emerald-300',
    'Event Coordinators':      'bg-amber-100 text-amber-700 border-amber-300',
    'Everyone in Event':       'bg-indigo-100 text-indigo-700 border-indigo-300',
    // Generic groups
    'All Users':               'bg-slate-100 text-slate-700 border-slate-300',
    'Participants':            'bg-blue-100 text-blue-700 border-blue-300',
};
