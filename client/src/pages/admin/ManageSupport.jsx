...
import { 
    ...
    MoreVertical, ExternalLink, ArrowLeft, HelpCircle
} from 'lucide-react';
...
const ManageSupport = () => {
    ...
    const fetchQueries = async () => {
        try {
            ...
            toast.error('Failed to load user care queries');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="space-y-8 pb-40">
            <AdminTopBar
                title="User Care & Support"
                subtitle="Monitor, manage, and resolve user complaints and support tickets."
                icon={HelpCircle}
            />
