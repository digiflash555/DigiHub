    ...
    return (
        <div className="space-y-8 pb-40">
            <AdminTopBar
                ...
                subtitle="Comprehensive view of all participants and their event attendance history."
                icon={Users}
                actions={
                    <button
                        onClick={downloadXLSX}
                        className="flex items-center gap-2 px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-xl text-xs font-black uppercase tracking-widest transition-all active:scale-95 border border-white/20"
                    >
                        <Download className="w-4 h-4" />
                        Export XLSX
                        {activeDateLabel && (
                            <span className="px-2 py-0.5 bg-white/20 rounded text-[10px]">Filtered</span>
                        )}
                    </button>
                }
            />
