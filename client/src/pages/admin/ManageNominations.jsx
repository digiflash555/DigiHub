    ...
    return (
        <div className="space-y-8 pb-40">
            <AdminTopBar
                ...
                subtitle="Review, approve, edit, and export candidate nominations with multi-stage verification."
                icon={Award}
                badge="Election Review"
                actions={
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        <div className="relative" ref={exportRef}>
                            <button
                                ...
                                className="px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white font-bold rounded-xl transition-all flex items-center gap-2 border border-white/10"
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="px-3 py-2 pl-9 bg-white/10 text-white placeholder-slate-400 text-sm font-medium rounded-xl border border-white/10 focus:outline-none focus:bg-white/20 w-48"
                                value={searchTerm}
                                onChange={(e) => setSearchTerm(e.target.value)}
                            />
                        </div>
                        <select
                            className="px-3 py-2 bg-white/10 text-white text-sm font-medium rounded-xl border border-white/10 focus:outline-none focus:bg-white/20 dark:bg-slate-800"
                            value={filterStatus}
                            onChange={(e) => setFilterStatus(e.target.value)}
                        >
                            <option value="All" className="text-slate-900 dark:text-white dark:bg-[#20242B]">All Statuses</option>
                            <option value="Pending Admin" className="text-slate-900 dark:text-white dark:bg-[#20242B]">Admin Review</option>
                            <option value="Approved" className="text-slate-900 dark:text-white dark:bg-[#20242B]">Approved</option>
                            <option value="Rejected" className="text-slate-900 dark:text-white dark:bg-[#20242B]">Rejected</option>
                        </select>
                    </div>
                }
            />
