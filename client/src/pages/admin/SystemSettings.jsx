...
import { Settings, Save, ChevronLeft, ToggleLeft, ToggleRight, Users, Calendar, Upload, Image, GraduationCap, AlertTriangle, Gamepad2 } from 'lucide-react';
...
const SystemSettings = () => {
    ...
    const handleSave = async () => {
        ...
        formData.append('gamesEnabled', settings.gamesEnabled);
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-12 pb-40">
            <AdminHeader
                ...
                subtitle="Configure global system settings, permissions, and platform behavior."
                icon={Settings}
                actions={
                    <button
                        onClick={handleSave}
                        disabled={isSaving}
                        className="flex items-center gap-2 px-5 py-2.5 bg-white text-indigo-700 hover:bg-indigo-50 rounded-xl font-black text-xs transition-all shadow-md disabled:opacity-60"
                    >
            ...
            <div className="space-y-8">
                ...
                >
                    <div className="flex items-center gap-4 mb-6">
                        <div className="w-14 h-14 bg-gradient-to-br from-indigo-500 to-violet-600 dark:from-indigo-600 dark:to-violet-700 rounded-2xl flex items-center justify-center text-white shadow-lg">
                    ...
                    <div className="space-y-6">
                        <div className="group flex items-center justify-between p-6 bg-slate-50 dark:bg-[#1a1d24] rounded-2xl hover:bg-slate-100 dark:hover:bg-[#2a2e36] transition-colors">
                            ...
                            <button
                                ...
                                className={`relative w-16 h-8 rounded-full transition-colors ${settings.nominationFormsEnabled ? 'bg-gradient-to-r from-indigo-500 to-violet-600' : 'bg-slate-300 dark:bg-slate-600'}`}
                            >
                                <div className={`absolute top-1 w-6 h-6 rounded-full bg-white dark:bg-[#20242B] transition-transform shadow-sm ${settings.nominationFormsEnabled ? 'translate-x-8' : 'translate-x-1'}`} />
                            </button>
                        </div>
                        ...
                        <div className="group flex items-center justify-between p-6 bg-slate-50 dark:bg-[#1a1d24] rounded-2xl hover:bg-slate-100 dark:hover:bg-[#2a2e36] transition-colors">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="font-black text-slate-900 dark:text-white">Enable Games & Arcade</h3>
                                    <p className="text-sm text-slate-500 dark:text-slate-400">Allow users to play games on the platform</p>
                                </div>
                            </div>
                            <button
                                onClick={() => setSettings({ ...settings, gamesEnabled: !settings.gamesEnabled })}
                                className={`relative w-16 h-8 rounded-full transition-colors ${settings.gamesEnabled ? 'bg-gradient-to-r from-violet-500 to-purple-600' : 'bg-slate-300 dark:bg-slate-600'}`}
                            >
                                <div className={`absolute top-1 w-6 h-6 rounded-full bg-white dark:bg-[#20242B] transition-transform shadow-sm ${settings.gamesEnabled ? 'translate-x-8' : 'translate-x-1'}`} />
                            </button>
                        </div>
                ...
                >
                    <div className="flex items-center gap-4 mb-6">
                        <div className="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-600 dark:from-emerald-600 dark:to-teal-700 rounded-2xl flex items-center justify-center text-white shadow-lg">
