...
exports.updateSettings = async (req, res, next) => {
    try {
        ...
        if (req.body.nominationFormsEnabled !== undefined) {
            updateData.nominationFormsEnabled = req.body.nominationFormsEnabled === 'true' || req.body.nominationFormsEnabled === true;
        }
        if (req.body.gamesEnabled !== undefined) {
            updateData.gamesEnabled = req.body.gamesEnabled === 'true' || req.body.gamesEnabled === true;
        }
...
exports.promoteStudents = async (req, res, next) => {
    try {
        ...
        const students = await User.find({ role: { $in: ['Participant', 'Student'] } });
        let promotedCount = 0;
