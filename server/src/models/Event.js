...
const eventSchema = new mongoose.Schema({
    ...
    registrationRestrictionMode: { 
        type: String, 
        enum: ['Open to All Students', 'Restrict by Class & Section'], 
        default: 'Open to All Students' 
    },
    allocations: [{
        yearAndDept: { type: String },
        section: { type: String },
    ...
    certificateConfig: {
        ...
        fields: [{
            ...
            variableUnderlines: { type: mongoose.Schema.Types.Mixed, default: {} },
