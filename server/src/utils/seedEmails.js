...
const DEFAULT_TEMPLATES = [
  ...
  <p style="text-align:center;color:#94a3b8;font-size:12px;">DigiHub Events Platform — This is an automated message.</p>
    ...
    },
    {
        ...
        subject: '🎂 Happy Birthday, {{user_name}}! Warm Wishes from DigiFlash Association of CSE',
        body: `<div style="font-family:'Segoe UI',Arial,sans-serif;max-width:640px;margin:0 auto;background:#0f0c29;padding:0;border-radius:20px;overflow:hidden;">
  <!-- Hero Banner -->
  <div style="background:linear-gradient(135deg,#f953c6 0%,#b91d73 40%,#fc5c7d 70%,#f9d423 100%);padding:48px 32px;text-align:center;position:relative;">
    <div style="font-size:60px;margin-bottom:8px;">🎉</div>
    <h1 style="color:#fff;margin:0;font-size:34px;font-weight:900;letter-spacing:1px;text-shadow:0 2px 12px rgba(0,0,0,0.25);">Happy Birthday!</h1>
    <p style="color:rgba(255,255,255,0.92);margin:10px 0 0 0;font-size:18px;font-weight:600;">{{user_name}} 🎂</p>
    <div style="margin-top:18px;display:inline-block;background:rgba(255,255,255,0.18);padding:8px 22px;border-radius:30px;">
      <span style="color:#fff;font-size:13px;letter-spacing:2px;font-weight:700;text-transform:uppercase;">DigiFlash Association of CSE</span>
    </div>
  </div>

  <!-- Main Content -->
  <div style="background:#1a1a2e;padding:36px 32px;">
    <p style="color:#e2e8f0;font-size:16px;line-height:1.8;margin:0 0 18px 0;">
      Dear <strong style="color:#f9d423;">{{user_name}}</strong>,
    </p>
    <p style="color:#cbd5e1;font-size:15px;line-height:1.85;margin:0 0 18px 0;">
      On this very special day, the entire <strong style="color:#fc5c7d;">DigiFlash Association of CSE</strong> family comes together to celebrate <em>you</em>! 🎊
    </p>
    <p style="color:#cbd5e1;font-size:15px;line-height:1.85;margin:0 0 24px 0;">
      May your birthday be the beginning of a year filled with <strong style="color:#f9d423;">joy</strong>, <strong style="color:#f953c6;">success</strong>, and every dream you've ever dared to dream. You are a wonderful part of our community, and we are truly grateful to have you with us. ✨
    </p>

    <!-- Quote Card -->
    <div style="background:linear-gradient(135deg,#16213e,#0f3460);border-left:4px solid #f9d423;border-radius:12px;padding:22px 24px;margin:24px 0;">
      <p style="color:#f9d423;font-size:15px;font-style:italic;margin:0 0 8px 0;line-height:1.7;">
        "The secret of getting ahead is getting started. Today is your day — make it extraordinary!"
      </p>
      <p style="color:#94a3b8;font-size:13px;margin:0;">— DigiFlash Association of CSE 💡</p>
    </div>

    <p style="color:#cbd5e1;font-size:15px;line-height:1.85;margin:18px 0 0 0;">
      Keep shining, keep coding, and keep inspiring everyone around you. Here's to a fantastic new chapter in your journey! 🚀
    </p>
  </div>

  <!-- Balloon Row -->
  <div style="background:#16213e;padding:16px 32px;text-align:center;font-size:28px;letter-spacing:6px;">
    🎈 🎁 🎂 🎊 🎈
  </div>

  <!-- Footer -->
  <div style="background:#0f0c29;padding:28px 32px;text-align:center;border-top:1px solid #2d2d5e;">
    <p style="color:#f953c6;font-size:15px;font-weight:700;margin:0 0 6px 0;">With love & best wishes,</p>
    <p style="color:#e2e8f0;font-size:15px;font-weight:800;margin:0 0 4px 0;">DigiFlash Association of CSE</p>
    <p style="color:#64748b;font-size:12px;margin:12px 0 0 0;">This is an automated birthday greeting. 🎂 Have a wonderful day!</p>
  </div>
</div>`,
        recipientType: 'User',
    ...
    {
        name: 'Winner Achievement Liked',
        trigger: 'WINNER_LIKE',
        subject: 'Someone liked your achievement!',
        body: '<p><h3>Congratulations!</h3></p><p><strong>{{liker_name}}</strong> just liked your winning entry for the event <strong>{{event_title}}</strong>!</p><p>Keep up the great work!</p>',
        recipientType: 'Participant',
        availableVariables: ['liker_name', 'event_title']
    },
    {
        name: 'Winner Achievement Commented',
        trigger: 'WINNER_COMMENT',
        subject: 'New comment on your achievement!',
        body: '<p><h3>New Comment</h3></p><p><strong>{{commenter_name}}</strong> commented on your winning entry for the event <strong>{{event_title}}</strong>:</p><blockquote style="border-left: 4px solid #ccc; padding-left: 10px; margin-left: 0; font-style: italic;">{{comment_text}}</blockquote><p>Log in to view the comment.</p>',
        recipientType: 'Participant',
        availableVariables: ['commenter_name', 'event_title', 'comment_text']
    }
];
